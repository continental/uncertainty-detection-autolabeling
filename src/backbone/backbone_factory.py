...
def get_model(model_name, override_params=None, model_dir=None, extra_config=None):
  ...
  return efficientnet_model.Model(blocks_args, global_params, model_name, extra_config)
