        ...
        def _call(inputs):
            ...
            if self._block_args.fused_conv:
                ...
                if self._block_args.expand_ratio != 1:
                    ...
                    if self.mc_dropout:
                        x = tf.keras.layers.SpatialDropout2D(self.mc_dropoutrate)(
                            x, training=True
                        )  # add mc after depthwise activationa
...
class Model(tf.keras.Model):
    ...
    def __init__(
        self, blocks_args=None, global_params=None, name=None, extra_config=None
    ):
