...
r""" Modified. Originally named inference.py. 
...
from tensorflow.python.client import (
    timeline,  # pylint: disable=g-direct-tensorflow-import
)
...
def batch_image_preprocess(
    ...
    for i in range(batch_size):
        image, scale = image_preprocess(raw_images[i], image_size, mean_rgb, stddev_rgb)
        scales.append(scale)
        images.append(image)
